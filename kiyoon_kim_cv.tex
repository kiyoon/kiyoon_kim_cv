...
\begin{minipage}[l]{0.33\textwidth}
 \includegraphics{Kiyoon.jpg}
\end{minipage}
\begin{minipage}[r]{0.50\textwidth}
 Hello, I'm a computer scientist with machine learning and signal processing background.
 
\end{minipage}
%----------HEADING-----------------
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
  \textbf{\href{http://kiyoon.kim/}{\Large Kiyoon Kim}} & Email : \ \ \ \ \ \ \href{mailto:im@kiyoon.kim}{im@kiyoon.kim}\\
  \href{http://kiyoon.kim/}{http://kiyoon.kim/} & \href{mailto:k.kim-20@sms.ed.ac.uk}{k.kim-20@sms.ed.ac.uk}\\
  & Mobile : \ \ \ +44-7494-630465 \\
\end{tabular*}
...
\section{Education}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      {MSc in Artificial Intelligence}{Sep 2018 -- Sep 2019 (Estimated)}
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Contribution Award\footnotemark}
          {Chairman's Award}
        \resumeItem{GPA of Computer Science and Engineering}
          {\numprint{4.15}/\numprint{4.3} (\numprint{97.5}/100)}
        \resumeItem{GPA of Electrical Engineering}
          {\numprint{3.94}/\numprint{4.3} (\numprint{95.4}/100)}
        \resumeItem{GPA of both majors}
          {\numprint{4.00}/\numprint{4.3} (\numprint{96.0}/100)}
...
\section{Experience}
  \resumeSubHeadingListStart
    \resumeSubheading
      {Tutor of Imperative Programming}{University of Edinburgh}
      {Tutored Java programming with Greenfoot IDE.}{Nov 2018}
    \resumeSubheading
      {Private Teaching}{Personal}
      {Taught TOEIC (English) to a job seeker.}{Jul 2018 -- Aug 2018}
    \resumeSubheading
      {Private Teaching}{Personal}
      {Taught R Language to a master student.}{Apr 2018}
    \resumeSubheading
      {NAVER UNIST Undergraduate Poster Award (NAVER UUPA)}{NAVER Corp., UNIST}
    ...
    \resumeSubheading
      ...
      {Taught the subject for 3 semesters, to 3 university students per semester.}{Sep 2014 -- Dec 2015}
      
    \resumeSubheading
      {Private Teaching}{Personal}
      {Taught mathematics to a high school student.}{Jul 2014 -- Aug 2014}
      
    \resumeSubheading
      {Math Teacher at Private School}{Morning of Math}
